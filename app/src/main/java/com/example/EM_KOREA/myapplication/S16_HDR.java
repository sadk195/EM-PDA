...
public class S16_HDR implements Serializable {   //Serializable 객체를 파라미터로 다른 ACTIVITY에 전달할때 필요함.
    ...
    public void setDE_COUNT(String detail_count) { DE_COUNT = detail_count; }
}
