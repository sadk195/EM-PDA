...
public class S15_QUERY_ListViewAdapter extends BaseAdapter {

    private ArrayList<S15_QUERY> listViewItem = new ArrayList<S15_QUERY>();

    public S15_QUERY_ListViewAdapter() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_view_s15_query, parent, false);
        }
        ...
        S15_QUERY item = listViewItem.get(position);
    ...
    protected void addQueryItem(S15_QUERY item) {
        listViewItem.add(item);
    }
