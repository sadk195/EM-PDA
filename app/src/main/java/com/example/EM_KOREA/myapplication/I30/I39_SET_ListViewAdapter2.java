...
public class I39_SET_ListViewAdapter2 extends BaseAdapter {

    private ArrayList<I39_SET2> listViewItem = new ArrayList<I39_SET2>();

    public I39_SET_ListViewAdapter2() {
    ...
    protected void addHDRItem(I39_SET2 item) {
        listViewItem.add(item);
    }
