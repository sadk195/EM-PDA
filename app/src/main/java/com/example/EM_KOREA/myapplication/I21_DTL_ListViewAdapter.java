...
public class I21_DTL_ListViewAdapter extends BaseAdapter {

    private ArrayList<I21_DTL> listViewItem = new ArrayList<I21_DTL>();

    public I21_DTL_ListViewAdapter() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_view_i21_dtl, parent, false);
        }
        ...
        I21_DTL item = listViewItem.get(position);
    ...
    public void add_Loading_Place_Dtl_Item(String CHK, String TRACKING_NO, String LOT_NO, String GOOD_ON_HAND_QTY, String BAD_ON_HAND_QTY, String SL_CD, String ITEM_CD, String LOT_SUB_NO, String BASIC_UNIT, String LOCATION) {
    ...
    protected void addDTLItem(I21_DTL item) {
        listViewItem.add(item);
    }
}
