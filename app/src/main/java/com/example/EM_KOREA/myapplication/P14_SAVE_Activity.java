    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_start.setOnClickListener(new View.OnClickListener() {        //실적등록버튼
            ...
            public void onClick(View v) {
                ...
                {
                    TGSClass.AlterMessage(getApplicationContext(), "작업장별 실적등록을 관리하므로 실적 버튼만을 사용합니다.");
                }
                else if(state_message.getText().toString().equals("* 작업 중 *"))
                {
                    TGSClass.AlterMessage(getApplicationContext(), "작업 중입니다.");
                }
                else
                {
                    ...
                    {
                        AlertDialog.Builder builder = new AlertDialog.Builder(P14_SAVE_Activity.this);
                    ...
                    else
                    {
                        AlertDialog.Builder builder = new AlertDialog.Builder(P14_SAVE_Activity.this);
                        builder.setTitle("공정별 실적등록");
                        builder.setMessage("작업 시작하시겠습니까?");
                            ...
                            public void onClick(DialogInterface dialog, int which)
                            {
                                try
                                {
                                    if(DBQuery_StartWork() == true)
                                    {
                                        ...
                                        AlertDialog.Builder builder = new AlertDialog.Builder(P14_SAVE_Activity.this);
                                        builder.setTitle("공정별 실적등록");
                                        builder.setMessage("작업 중입니다. 설비 변경 불가능");
                                        builder.setPositiveButton("확인",null);
                                        builder.create().show();
                                    }
                                }
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {        //실적등록버튼
            ...
            public void onClick(View v)
            {
                ...
                {
                    TGSClass.AlterMessage(getApplicationContext(), "작업 대기중입니다.");
                    return;
                }
                else
                {
        ...
        btn_reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TGSClass.AlterMessage(getApplicationContext(), "아직 기능이 없습니다.");
                //InitData();
            }
        });
        ...
        btn_cancle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                if(state_message.getText().toString().equals("* 작업 대기 중 *"))
                {
                    TGSClass.AlterMessage(getApplicationContext(),"작업이 시작되지 않았습니다.");
                    return;
                }
                ...
                {
                    AlertDialog.Builder builder = new AlertDialog.Builder(P14_SAVE_Activity.this);
                    builder.setTitle("작업 취소");
                    builder.setMessage("작업 시작을 취소 하시겠습니까?");
                    builder.setPositiveButton("예", new DialogInterface.OnClickListener()
                    {
                        @Override public void onClick(DialogInterface dialog, int which)
                        {
