...
public class I39_DEL_ListViewAdapter2 extends BaseAdapter {

    private ArrayList<I39_DEL2> listViewItem = new ArrayList<I39_DEL2>();

    public I39_DEL_ListViewAdapter2() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        I39_DEL2 item = listViewItem.get(position);
    ...
    protected void addHDRItem(I39_DEL2 item) {
        listViewItem.add(item);
    }
