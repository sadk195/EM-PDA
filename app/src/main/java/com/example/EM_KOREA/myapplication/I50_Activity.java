                ...
                switch (v.getId()) {
                    ...
                    case R.id.btn_inventory_disposal:
                        ...
                        if (start_grant("I51")) {
                            ...
                            Intent intent = TGSClass.ChangeView(getPackageName(), I51_HDR_Activity.class.getSimpleName());
                    ...
                    case R.id.btn_inventory_disposal_status:
                        ...
                        if (start_grant("I52")) {
                            ...
                            Intent intent = TGSClass.ChangeView(getPackageName(), I52_HDR_Activity.class.getSimpleName());
