    ...
    private void initializeListener() {
        ...
        btn_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //정영진
                Intent intent = TGSClass.ChangeView(getPackageName(), P10_Activity.class.getSimpleName());
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                ...
                if ((keyCode == KeyEvent.KEYCODE_ENTER)) {
                    ...
                    if (!txt_Scan_lbl_prodt_order_no.getText().toString().equals("") && (Scan_Text_Len == 12 || Scan_Text_Len == 11)) {
                        ...
                        Intent intent = TGSClass.ChangeView(getPackageName(), P14_SAVE_Activity.class.getSimpleName());
                        ...
                        TGSClass.AlterMessage(getApplicationContext(), "[제조오더번호-공순]을 정확히 입력하여 주시기 바랍니다");
                        return false;
                    }
                }
                return false;
