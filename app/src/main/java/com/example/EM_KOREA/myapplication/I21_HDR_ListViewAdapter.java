...
public class I21_HDR_ListViewAdapter extends BaseAdapter {

    private ArrayList<I21_HDR> listViewItem = new ArrayList<I21_HDR>();

    public I21_HDR_ListViewAdapter() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_view_i21_hdr, parent, false);
        }
        ...
        I21_HDR item = listViewItem.get(position);
    ...
    protected void addHDRItem(I21_HDR item) {
        listViewItem.add(item);
    }
