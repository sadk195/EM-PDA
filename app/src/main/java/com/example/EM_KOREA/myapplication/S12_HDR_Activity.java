            ...
            try {
                ...
                listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView parent, View v, int position, long id) {
                        ...
                        Intent intent = TGSClass.ChangeView(getPackageName(), S12_DTL_Activity.class.getSimpleName());
            ...
            public void run() {
                ...
                try {
                    ...
                    if (!vStatus.equals("OK")) {
                        TGSClass.AlterMessage(S12_HDR_Activity.this, vMSG);
                        return;
                    }
                } catch (JSONException ex) {
                    TGSClass.AlterMessage(S12_HDR_Activity.this, ex.toString());
                    return;
                }
            }
        };
    ...
    private void dbQuery_getComboData() {
        ...
        try {
            ...
            BP_CD.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                @Override
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    str_BP_CD = ((GetComboNUM) parent.getSelectedItem()).getMINOR_CD();
                    start();
                }
