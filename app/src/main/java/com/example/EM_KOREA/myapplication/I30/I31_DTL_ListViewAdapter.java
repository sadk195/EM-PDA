...
public class I31_DTL_ListViewAdapter extends BaseAdapter {

    private ArrayList<I31_DTL> listViewItem = new ArrayList<I31_DTL>();

    public I31_DTL_ListViewAdapter() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_view_i31_dtl, parent, false);
        }
        ...
        I31_DTL item = listViewItem.get(position);
    ...
    public void add_Item(String ITEM_CD, String ITEM_NM, String GOOD_QTY, String SL_CD, String SL_NM, String TRACKING_NO, String GOOD_ON_HAND_QTY) {
    ...
    protected void addDTLItem(I31_DTL item) {
        listViewItem.add(item);
    }
