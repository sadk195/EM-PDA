            ...
            public void onClick(View v) {
                if (v == btn_menu) {        // 메뉴 버튼
                    ...
                    if(start_grant("I31") == true) {
                        Intent intent = TGSClass.ChangeView(getPackageName(), I31_HDR_Activity.class.getSimpleName());
                    ...
                    if(start_grant("I32") == true) {
                        Intent intent = TGSClass.ChangeView(getPackageName(), I32_HDR_Activity.class.getSimpleName());
                    ...
                    if(start_grant("I33") == true) {
                        Intent intent = TGSClass.ChangeView(getPackageName(), I33_HDR_Activity.class.getSimpleName());
                    ...
                    if(start_grant("I34") == true) {
                        Intent intent = TGSClass.ChangeView(getPackageName(), I34_QUERY_Activity.class.getSimpleName());
                    ...
                    if(start_grant("I36") == true) {
                        Intent intent = TGSClass.ChangeView(getPackageName(), I36_QUERY_Activity.class.getSimpleName());
                    ...
                    if(start_grant("I37") == true) {
                        Intent intent = TGSClass.ChangeView(getPackageName(), I37_HDR_Activity.class.getSimpleName());
                    ...
                    if(start_grant("I38") == true) {
                        Intent intent = TGSClass.ChangeView(getPackageName(), I38_HDR_Activity.class.getSimpleName());
