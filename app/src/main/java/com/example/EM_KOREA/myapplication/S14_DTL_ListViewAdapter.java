...
public class S14_DTL_ListViewAdapter extends BaseAdapter {

    private ArrayList<S14_DTL> listViewItem = new ArrayList<S14_DTL>();

    public S14_DTL_ListViewAdapter() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_view_s14_dtl, parent, false);
        }
        ...
        S14_DTL item = listViewItem.get(position);
    ...
    public void addDtlItem(S14_DTL item) {
        listViewItem.add(item);
    }
}
