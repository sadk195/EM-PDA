...
public class S16_HDR_Activity extends BaseActivity {
        ...
        btn_query.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (dn_req_no.getText().toString().equals("")) {
                    TGSClass.AlterMessage(getApplicationContext(), "조회조건 [출하요청번호]는 필수입력사항입니다.");
                } else {
                    start();
                }
            }
    ...
    private void start() {
        //TGSClass.AlterMessage(getApplicationContext(), BP_CD.getOnItemSelectedListener().toString());
        ...
        if (!sJson.equals("[]")) {
            try {
                ...
                listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView parent, View v, int position, long id) {
                        ...
                        if (!vItem.getLOCATION().equals("출하대기장")) {
                            TGSClass.AlterMessage(getApplicationContext(), "선택하신 품목의 적치장이 [출하대기장]으로 이동되지 않았습니다.");
                        } else {
                            //Toast.makeText(P_OEM11_Activity.this ,vSelectItem,Toast.LENGTH_LONG).show();

                            Intent intent = TGSClass.ChangeView(getPackageName(), S16_DTL_Activity.class.getSimpleName());
                ...
                TGSClass.AlterMessage(this, ja.length() + " 건 조회되었습니다.", 1000);
            ...
            TGSClass.AlterMessage(this, "조회내역이 없습니다.");
        }
    }
        ...
        try {
            ...
            BP_CD.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    sJOB_CD = ((GetComboNUM) parent.getSelectedItem()).getMINOR_CD();
                    //Start();
                }
