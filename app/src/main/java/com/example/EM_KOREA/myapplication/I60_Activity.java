...
public class I60_Activity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i60_sub_menu);
    ...
    private void initializeView() {
        ...
        //== ID값 바인딩 ==//
        btn_material_delivery           = (Button) findViewById(R.id.btn_material_delivery);        // 1. 개발용자재출고
        btn_material_import_good        = (Button) findViewById(R.id.btn_material_import_good);     // 2. 개발용자재반입(양품)
        btn_material_import_bad         = (Button) findViewById(R.id.btn_material_import_bad);      // 3. 개발용자재반입(불량)
        btn_material_status             = (Button) findViewById(R.id.btn_material_status);          // 4. 개발용출고/반입현황
                ...
                switch (v.getId()) {
                    ...
                    case R.id.btn_material_delivery:
                        ...
                        if(start_grant("I61") == true) {
                            Intent intent = TGSClass.ChangeView(getPackageName(), I61_HDR_Activity.class.getSimpleName());
                    ...
                    case R.id.btn_material_import_good:
                        if(start_grant("I62") == true) {
                            Intent intent = TGSClass.ChangeView(getPackageName(), I62_HDR_Activity.class.getSimpleName());
                    ...
                    case R.id.btn_material_import_bad:
                        ...
                        if(start_grant("I63") == true) {
                            Intent intent = TGSClass.ChangeView(getPackageName(), I63_HDR_Activity.class.getSimpleName());
                    ...
                    case R.id.btn_material_status:
                        ...
                        if(start_grant("I64") == true) {
                            Intent intent = TGSClass.ChangeView(getPackageName(), I64_HDR_Activity.class.getSimpleName());
        ...
        try {
            ...
            if (ADMIN_CHK.equals("N") && W_OUT.equals("N")) {
                if (MenuID.equals("I61") && I61.equals("N")) {
                    TGSClass.AlterMessage(getApplicationContext(), "개발용 자재출고 메뉴에 대한 접속 권한이 없습니다.");
                    return false;
                } else if (MenuID.equals("I62") && I62.equals("N")) {
                    TGSClass.AlterMessage(getApplicationContext(), "개발용 자재반입(양품) 메뉴에 대한 접속 권한이 없습니다.");
                    return false;
                } else if (MenuID.equals("I63") && I63.equals("N")) {
                    TGSClass.AlterMessage(getApplicationContext(), "개발용 자재반입(불량) 메뉴에 대한 접속 권한이 없습니다.");
                    return false;
                } else if (MenuID.equals("I64") && I64.equals("N")) {
                    TGSClass.AlterMessage(getApplicationContext(), "개발용 출고/반입 현황 메뉴에 대한 접속 권한이 없습니다.");
                    return false;
                }
            }
            return true;
