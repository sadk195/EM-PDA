...
public class I22_DTL_ListViewAdapter extends BaseAdapter {

    private ArrayList<I22_DTL> listViewItem = new ArrayList<I22_DTL>();

    public I22_DTL_ListViewAdapter() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_view_i22_dtl, parent, false);
        }
        ...
        I22_DTL item = listViewItem.get(position);
    ...
    protected void addDTLItem(I22_DTL item) {
        listViewItem.add(item);
    }
}
