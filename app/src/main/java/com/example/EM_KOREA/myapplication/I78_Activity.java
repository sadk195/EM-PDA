        ...
        btn_new_inventory_hdr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (inv_no_hdr_info() == false) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(I78_Activity.this);
                            ...
                            .setPositiveButton("예", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    if (save_inv_no_hdr() == true) {
                                        TGSClass.AlterMessage(getApplicationContext(), "신규 생성이 완료 되었습니다.", Toast.LENGTH_LONG);
                                    }
                                }
                            })
