...
public class S16_HDR_ListViewAdapter extends BaseAdapter {

    private ArrayList<S16_HDR> listViewItem = new ArrayList<S16_HDR>();

    public S16_HDR_ListViewAdapter() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_view_s16_hdr, parent, false);
        }

        // 화면에 표시될 View(Layout이 inflate된)으로부터 위젯에 대한 참조 획득
        TextView ship_to_party_nm   = (TextView) convertView.findViewById(R.id.ship_to_party_nm);
        TextView de_count           = (TextView) convertView.findViewById(R.id.de_count);
        ...
        S16_HDR item2 = listViewItem.get(position);

        // 아이템 내 각 위젯에 데이터 반영
        ship_to_party_nm.setText(item2.getSHIP_TO_PARTY_NM());
        de_count.setText(item2.getDE_COUNT());
    ...
    public void addShipmentItem(String SHIP_TO_PARTY_NM, String DE_COUNT, String DN_NO, String SHIP_TO_PARTY, String MOV_TYPE, String SO_TYPE, String PLANT_CD, String SL_CD, String START_DT, String END_DT, String DN_REQ_NO, String PROMISE_DT, String LOCATION, String TRANS_METH) {
    ...
    public void add_Shipment_Hdr_Item(S16_HDR item) {
        listViewItem.add(item);
    }
