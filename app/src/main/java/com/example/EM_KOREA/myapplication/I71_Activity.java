...
public class I71_Activity extends BaseActivity {
    ...
    private void initializeListener() {
        ...
        btn_inventory_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = TGSClass.ChangeView(getPackageName(), I79_Activity.class.getSimpleName());
        ...
        btn_selectd_query.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = TGSClass.ChangeView(getPackageName(), I73_Activity.class.getSimpleName());
    ...
    private void ChangeView(String vSL_CD, String pMenuRemark) {
        Intent intent = TGSClass.ChangeView(getPackageName(), M11_DTL_Activity.class.getSimpleName());
        intent.putExtra("SL_CD", vSL_CD);
    ...
    private void start() {
        if (!sJson.equals("[]")) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(I71_Activity.this);
            builder.setTitle("재고실사등록");
            builder.setMessage("재고실사등록 번호가 없습니다. 신규 번호를 생성하시겠습니까 ?");
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                */
                ...
                Intent intent = TGSClass.ChangeView(getPackageName(), I72_Activity.class.getSimpleName());
