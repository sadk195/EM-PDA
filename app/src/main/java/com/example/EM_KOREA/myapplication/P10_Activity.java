...
public class P10_Activity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_p10_sub_menu);
    ...
    private void initializeView() {
        ...
        btn_c1_traveler_register        = (Button) findViewById(R.id.btn_c1_traveler_register);         // 1. TRAVELER실적등록
                ...
                switch (v.getId()) {
                    ...
                    case R.id.btn_h1_outorder_register:     // 4. (함안)공정외주실적등록
                        if (vPLANT_CD.equals("C1")) {
                            ...
                            if (start_grant("P14")) {
                                Intent intent = TGSClass.ChangeView(getPackageName(), P14_QUERY_Activity.class.getSimpleName());
