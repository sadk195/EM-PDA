...
public class I31_HDR_ListViewAdapter extends BaseAdapter {

    private ArrayList<I31_HDR> listViewItem = new ArrayList<I31_HDR>();

    public I31_HDR_ListViewAdapter() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_view_i31_hdr, parent, false);
        }
        ...
        I31_HDR item = listViewItem.get(position);
    ...
    public void add_Loading_Place_Item(String PRODT_ORDER_NO, String OPR_NO, String ITEM_CD, String ITEM_NM, String TRACKING_NO, String REQ_QTY, String BASE_UNIT,
                                       String SL_CD, String SL_NM, String ISSUED_QTY, String REMAIN_QTY, String REQ_NO, String ISSUE_MTHD, String RESV_STATUS, String OUT_QTY, String SEQ_NO) {
    ...
    protected void addHDRItem(I31_HDR item) {
        listViewItem.add(item);
    }
