...
public class I25_QUERY_ListViewAdapter extends BaseAdapter {

    private ArrayList<I25_QUERY> listViewItem = new ArrayList<I25_QUERY>();

    public I25_QUERY_ListViewAdapter() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_view_i25_query, parent, false);
        }
        ...
        I25_QUERY item = listViewItem.get(position);
    ...
    protected void addQueryItem(I25_QUERY item) {
        listViewItem.add(item);
    }
}
