        ...
        View.OnClickListener clickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (v == btn_menu) {
                    ...
                    Intent intent = TGSClass.ChangeView(getPackageName(), I11_HDR_Activity.class.getSimpleName());
                    ...
                    Intent intent = TGSClass.ChangeView(getPackageName(), I13_QUERY_Activity.class.getSimpleName());
