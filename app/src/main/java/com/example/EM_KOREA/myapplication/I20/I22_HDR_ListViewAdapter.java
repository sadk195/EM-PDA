...
public class I22_HDR_ListViewAdapter extends BaseAdapter {

    private ArrayList<I22_HDR> listViewItem = new ArrayList<I22_HDR>();

    public I22_HDR_ListViewAdapter() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_view_i22_hdr, parent, false);
        }
        ...
        I22_HDR item = listViewItem.get(position);
    ...
    protected void addHDRItem(I22_HDR item) {
        listViewItem.add(item);
    }
}
