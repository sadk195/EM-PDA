...
public class I39_DEL_ListViewAdapter extends BaseAdapter {

    private ArrayList<I39_DEL> listViewItem = new ArrayList<I39_DEL>();

    public I39_DEL_ListViewAdapter() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        I39_DEL item = listViewItem.get(position);
    ...
    protected void addHDRItem(I39_DEL item) {
        listViewItem.add(item);
    }
