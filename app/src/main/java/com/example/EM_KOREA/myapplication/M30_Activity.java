...
public class M30_Activity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_m30_sub_menu);
    ...
    private void initializeView() {
        ...
        //== ID값 바인딩 ==//
        btn_arrival_registration    = (Button) findViewById(R.id.btn_arrival_registration);     // 1. 입하등록
        btn_arrival_query           = (Button) findViewById(R.id.btn_arrival_query);            // 2. 입하현황조회
        ...
        View.OnClickListener clickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (v == btn_menu) {
                    ...
                    // 현재 Activity 종료
                    finish();
                } else if (v == btn_arrival_registration) {
                    String sMenuName = "메뉴 > 입하관리 > 입하등록";

                    Intent intent = TGSClass.ChangeView(getPackageName(), M31_HDR_Activity.class.getSimpleName());
                    ...
                    /*
                    Intent intent = TGSClass.ChangeView(getPackageName(), M32_HDR_Activity.class.getSimpleName());
