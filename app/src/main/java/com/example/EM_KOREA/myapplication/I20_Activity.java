...
public class I20_Activity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i20_sub_menu);
    ...
    private void initializeView() {
        ...
        btn_stockyard       = (Button) findViewById(R.id.btn_stockyard);        // 1. 적치장이동
        btn_warehouse       = (Button) findViewById(R.id.btn_warehouse);        // 2. 창고이동
        btn_tracking        = (Button) findViewById(R.id.btn_tracking);         // 3. TRACKING이동
        btn_workplace       = (Button) findViewById(R.id.btn_workplace);        // 4. 사업장이동
        btn_query           = (Button) findViewById(R.id.btn_query);            // 5. 재고이동현황조회
        btn_move            = (Button) findViewById(R.id.btn_move);             // 6. 출고이동처리
        btn_item_qty_move   = (Button) findViewById(R.id.btn_item_qty_move);    // 7. 품목재고이동(함안)
    }
        ...
        View.OnClickListener clickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (v == btn_menu) {           // 메뉴
                    ...
                    // 현재 Activity 종료
                    finish();
                } else if (v == btn_stockyard) {    // 1. 적치장이동
                    if (start_grant("I21")) {
                        Intent intent = TGSClass.ChangeView(getPackageName(), I21_HDR_Activity.class.getSimpleName());
                    ...
                    if (start_grant("I22")) {
                        Intent intent = TGSClass.ChangeView(getPackageName(), I22_HDR_Activity.class.getSimpleName());
                    ...
                    /*
                    if (start_grant("I23")) {
                        Intent intent = TGSClass.ChangeView(getPackageName(), I23_HDR_Activity.class.getSimpleName());
                    ...
                    /*
                    if (start_grant("I24")) {
                        Intent intent = TGSClass.ChangeView(getPackageName(), I24_HDR_Activity.class.getSimpleName());
                    ...
                    if (start_grant("I25")) {
                        Intent intent = TGSClass.ChangeView(getPackageName(), I25_QUERY_Activity.class.getSimpleName());
                    ...
                    if (start_grant("I26")) {
                        ...
                        Intent intent = TGSClass.ChangeView(getPackageName(), I26_HDR_Activity.class.getSimpleName());
        ...
        try {
            ...
            if (ADMIN_CHK.equals("N") && W_MOVE.equals("N")) {
                if (MenuID.equals("I21") && I21.equals("N")) {
                    TGSClass.AlterMessage(getApplicationContext(), "적치장이동 메뉴에 대한 접속 권한이 없습니다.");
                    return false;
                } else if (MenuID.equals("I22") && I22.equals("N")) {
                    TGSClass.AlterMessage(getApplicationContext(), "창고이동 메뉴에 대한 접속 권한이 없습니다.");
                    return false;
                } else if (MenuID.equals("I23") && I23.equals("N")) {
                    TGSClass.AlterMessage(getApplicationContext(), "Tracking이동 메뉴에 대한 접속 권한이 없습니다.");
                    return false;
                } else if (MenuID.equals("I24") && I24.equals("N")) {
                    TGSClass.AlterMessage(getApplicationContext(), "사업장이동 메뉴에 대한 접속 권한이 없습니다.");
                    return false;
                } else if (MenuID.equals("I25") && I25.equals("N")) {
                    TGSClass.AlterMessage(getApplicationContext(), "재고이동현황조회 메뉴에 대한 접속 권한이 없습니다.");
                    return false;
                } else if (MenuID.equals("I26") && I26.equals("N")) {
                    TGSClass.AlterMessage(getApplicationContext(), "출고이동처리 메뉴에 대한 접속 권한이 없습니다.");
                    return false;
                } else if (MenuID.equals("I27") && I27.equals("N")) {
                    TGSClass.AlterMessage(getApplicationContext(), "품목재고이동 메뉴에 대한 접속 권한이 없습니다.");
                    return false;
                }
            }
