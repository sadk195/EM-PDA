            ...
            public void onClick(View v) {
                if (v == btn_menu) {            // 메뉴 버튼
                    ...
                    if (start_grant("M21")) {
                        ...
                        Intent intent = TGSClass.ChangeView(getPackageName(), M21_HDR_Activity.class.getSimpleName());
                    ...
                    if (start_grant("M22")) {
                        ...
                        Intent intent = TGSClass.ChangeView(getPackageName(), M22_QUERY_Activity.class.getSimpleName());
